drop function if exists public.queue_paid_report(uuid,uuid,uuid,text,text,text);
...
begin
  ...
  insert into public.reports(
    ...
    p_recovery_themes, p_schema_version, p_prompt_version, p_safety_version
...
revoke all on function public.queue_paid_report(uuid,uuid,uuid,text,text,text,jsonb) from public, anon, authenticated;
grant execute on function public.queue_paid_report(uuid,uuid,uuid,text,text,text,jsonb) to service_role;
