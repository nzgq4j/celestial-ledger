...
- Personal: two saved natal charts, ten personal daily readings per billing month, and a primary-chart weekly reading.
- Premium: five saved natal charts, one primary-chart daily reading, ten companion-chart daily readings per billing month, weekly reading, and one standard-report credit after each three successfully paid monthly periods.
