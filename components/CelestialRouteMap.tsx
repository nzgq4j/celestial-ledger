    ...
    <figure className="route-map" aria-labelledby="route-map-title">
      <svg viewBox="0 0 460 320" role="img">
        <title id="route-map-title">
          An original celestial navigation map with orbital routes and six
          waypoints
        </title>
        <defs>
        ...
        <g className="route-map__grid">
          {Array.from({ length: 12 }, (_, i) => (
            <line key={`v-${i}`} x1={i * 42} y1="0" x2={i * 42} y2="320" />
          ))}
          {Array.from({ length: 9 }, (_, i) => (
            <line key={`h-${i}`} x1="0" y1={i * 40} x2="460" y2={i * 40} />
          ))}
        </g>
        ...
        <path
          className="route-map__current"
          d="M22 264c54-49 85-18 125-50 31-25 18-61 59-79 42-19 68 25 104 3 28-18 16-54 80-73"
        />
        <path
          className="route-map__path"
          d="M86 84 198 55 333 96 378 196 276 264 126 238 86 84"
        />
