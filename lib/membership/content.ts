    ...
    page: {
      ...
      tiers: {
        ...
        premium: {
          ...
          features: [
            ...
            "20% member price on additional detailed reports",
          ],
          action: "Create account to begin",
        },
      },
      ...
      comparison: [
        ...
        },
        {
          ...
          premium: "Quarterly credit + 20% member price",
        },
      ],
    ...
    page: {
      ...
      tiers: {
        ...
        premium: {
          ...
          features: [
            ...
            "1 crédito trimestral para un informe estándar",
            "20% de descuento en informes adicionales",
          ],
          action: "Crear cuenta para comenzar",
        },
      },
      ...
      comparison: [
        ...
        },
        {
          ...
          premium: "Crédito trimestral + 20% para miembros",
        },
      ],
    ...
    page: {
      ...
      tiers: {
        ...
        premium: {
          ...
          features: [
            ...
            "1 crédit de rapport standard par trimestre",
            "20 % de tarif membre sur les rapports supplémentaires",
          ],
          action: "Créer un compte pour commencer",
        },
      },
      ...
      comparison: [
        ...
        },
        {
          ...
          free: "Tarif standard",
          personal: "10 % membre",
          premium: "Crédit trimestriel + 20 % membre",
        },
      ],
    ...
    page: {
      ...
      tiers: {
        ...
        premium: {
          ...
          features: [
            ...
            "1 Standardbericht-Guthaben pro Quartal",
            "20 % Mitgliedspreis auf weitere Berichte",
          ],
          action: "Konto erstellen und beginnen",
        },
      },
      ...
      comparison: [
        ...
        },
        {
          ...
          premium: "Quartalsguthaben + 20 % Mitgliedspreis",
        },
      ],
