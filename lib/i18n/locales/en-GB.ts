...
const pack = {
  ...
  messages: {
    ...
    account: {
      ...
      overview: "Overview",
      yourReadingsKicker: "Your current sky",
      yourReadingsTitle: "Your readings",
      reportsCombinedKicker: "Your deeper atlas",
      reportsCombinedTitle: "Reports and saved editions",
      currentMembership: "Current membership",
      freePlan: "Free",
      activeStatus: "Active",
      nextBillingDate: "Next billing date",
      accessEnds: "Access ends",
      freePlanCopy: "Your account currently uses the Free plan.",
      manageBilling: "Manage billing",
      openingBilling: "Opening billing…",
      billingOpenFailed: "Billing could not be opened.",
      reportStatePurchased: "Purchased and ready",
      reportStateGenerated: "Saved in your library",
      reportStateIncluded: "Included with Premium",
      reportStateAvailable: "Available to purchase",
      openLatestReport: "Open latest report",
      currentlyUnavailable: "Currently unavailable",
      reportHistoryTitle: "Saved report history",
