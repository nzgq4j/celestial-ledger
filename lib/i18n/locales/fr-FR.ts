...
const pack = {
  ...
  messages: {
    ...
    account: {
      ...
      dashboardWorkspaceName: "Observatoire des membres",
      dashboardWorkspaceCopy: "Votre espace privé",
      workspaceLabel: "Espace",
      overview: "Vue d’ensemble",
      accountLabel: "Compte",
      membershipBilling: "Adhésion et facturation",
      currentOrbit: "Orbite actuelle",
      viewMembership: "Voir l’adhésion",
      privateObservatory: "Observatoire privé",
      dashboardTitle: "Mon Celestial Atlas",
      chartsLabel: "Thèmes",
      readingsLabel: "Lectures",
      readyLabel: "Prêts",
      privateSkyTitle: "Votre ciel privé.",
      ...
      freePlanDescription:
        "Votre compte utilise actuellement l’offre gratuite.",
