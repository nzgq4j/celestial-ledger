...
const pack = {
  ...
  messages: {
    ...
    account: {
      ...
      yourReadingsKicker: "Votre ciel actuel",
      yourReadingsTitle: "Vos lectures",
      reportsCombinedKicker: "Votre atlas approfondi",
      reportsCombinedTitle: "Rapports et éditions enregistrées",
      currentMembership: "Adhésion actuelle",
      freePlan: "Gratuit",
      activeStatus: "Active",
      nextBillingDate: "Prochaine facturation",
      accessEnds: "Accès jusqu’au",
      freePlanCopy: "Votre compte utilise actuellement la formule gratuite.",
      manageBilling: "Gérer la facturation",
      openingBilling: "Ouverture de la facturation…",
      billingOpenFailed: "La facturation n’a pas pu être ouverte.",
      reportStatePurchased: "Acheté et prêt",
      reportStateGenerated: "Enregistré dans votre bibliothèque",
      reportStateIncluded: "Inclus avec Premium",
      reportStateAvailable: "Disponible à l’achat",
      openLatestReport: "Ouvrir le dernier rapport",
      currentlyUnavailable: "Actuellement indisponible",
      reportHistoryTitle: "Historique des rapports enregistrés",
      ...
      retryScheduled: "Une nouvelle tentative est en attente…",
