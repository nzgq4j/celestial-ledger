...
const pack = {
  ...
  messages: {
    ...
    account: {
      ...
      accountLabel: "Konto",
      overview: "Übersicht",
      yourReadingsKicker: "Ihr aktueller Himmel",
      yourReadingsTitle: "Ihre Deutungen",
      reportsCombinedKicker: "Ihr vertiefter Atlas",
      reportsCombinedTitle: "Berichte und gespeicherte Ausgaben",
      currentMembership: "Aktuelle Mitgliedschaft",
      freePlan: "Kostenlos",
      activeStatus: "Aktiv",
      nextBillingDate: "Nächste Abrechnung",
      accessEnds: "Zugang endet am",
      freePlanCopy: "Ihr Konto nutzt derzeit den kostenlosen Tarif.",
      manageBilling: "Abrechnung verwalten",
      openingBilling: "Abrechnung wird geöffnet…",
      billingOpenFailed: "Die Abrechnung konnte nicht geöffnet werden.",
      reportStatePurchased: "Gekauft und bereit",
      reportStateGenerated: "In Ihrer Bibliothek gespeichert",
      reportStateIncluded: "In Premium enthalten",
      reportStateAvailable: "Zum Kauf verfügbar",
      openLatestReport: "Neuesten Bericht öffnen",
      currentlyUnavailable: "Derzeit nicht verfügbar",
      reportHistoryTitle: "Gespeicherte Berichte",
