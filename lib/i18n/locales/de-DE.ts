...
const pack = {
  ...
  messages: {
    ...
    account: {
      ...
      dashboardWorkspaceName: "Mitglieder-Sternwarte",
      dashboardWorkspaceCopy: "Ihr privater Bereich",
      workspaceLabel: "Arbeitsbereich",
      overview: "Übersicht",
      accountLabel: "Konto",
      membershipBilling: "Mitgliedschaft & Abrechnung",
      currentOrbit: "Aktueller Orbit",
      viewMembership: "Mitgliedschaft ansehen",
      privateObservatory: "Private Sternwarte",
      dashboardTitle: "Mein Celestial Atlas",
      chartsLabel: "Horoskope",
      readingsLabel: "Deutungen",
      readyLabel: "Bereit",
      privateSkyTitle: "Ihr privater Himmel.",
      backToSite: "Zurück zur Website",
      freePlan: "Kostenlos",
      activeStatus: "Aktiv",
      accessEnds: "Zugriff endet am",
      nextBillingDate: "Nächste Abrechnung",
      freePlanDescription: "Ihr Konto nutzt derzeit den kostenlosen Tarif.",
