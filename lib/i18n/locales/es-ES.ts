...
const pack = {
  ...
  messages: {
    ...
    account: {
      ...
      accountLabel: "Cuenta",
      overview: "Resumen",
      yourReadingsKicker: "Tu cielo actual",
      yourReadingsTitle: "Tus lecturas",
      reportsCombinedKicker: "Tu atlas en profundidad",
      reportsCombinedTitle: "Informes y ediciones guardadas",
      currentMembership: "Membresía actual",
      freePlan: "Gratis",
      activeStatus: "Activa",
      nextBillingDate: "Próxima fecha de cobro",
      accessEnds: "El acceso termina el",
      freePlanCopy: "Tu cuenta utiliza actualmente el plan gratuito.",
      manageBilling: "Gestionar facturación",
      openingBilling: "Abriendo facturación…",
      billingOpenFailed: "No se pudo abrir la facturación.",
      reportStatePurchased: "Comprado y listo",
      reportStateGenerated: "Guardado en tu biblioteca",
      reportStateIncluded: "Incluido con Premium",
      reportStateAvailable: "Disponible para comprar",
      openLatestReport: "Abrir el informe más reciente",
      currentlyUnavailable: "No disponible actualmente",
      reportHistoryTitle: "Historial de informes guardados",
      ...
      openReadingOptions: "Abrir opciones de lectura",
      ...
      personaliseReport: "Configurar informe",
      grounding: "Arraigo",
    ...
    horoscopes: {
      ...
      bottomLine: "Lo esencial de hoy",
      relationships: "Relaciones y conexión",
      business: "Negocios y dirección",
      money: "Dinero y recursos",
      work: "Trabajo, propósito y movimiento práctico",
      wellbeing: "Ritmo de bienestar",
      dailyArc: "Tu día en tres movimientos",
      dailyArcIntroduction:
        "Sigue el cambio de énfasis desde la primera luz hasta el cierre del día.",
      morning: "Mañana",
      afternoon: "Tarde",
      evening: "Noche",
