...
const pack = {
  ...
  messages: {
    ...
    account: {
      ...
      dashboardWorkspaceName: "Observatorio de miembros",
      dashboardWorkspaceCopy: "Tu espacio privado",
      workspaceLabel: "Espacio",
      overview: "Resumen",
      accountLabel: "Cuenta",
      membershipBilling: "Membresía y facturación",
      currentOrbit: "Órbita actual",
      viewMembership: "Ver membresía",
      privateObservatory: "Observatorio privado",
      dashboardTitle: "Mi Celestial Atlas",
      chartsLabel: "Cartas",
      readingsLabel: "Lecturas",
      readyLabel: "Listos",
      privateSkyTitle: "Tu cielo privado.",
      backToSite: "Volver al sitio",
      freePlan: "Gratis",
      activeStatus: "Activo",
      accessEnds: "Acceso hasta",
      nextBillingDate: "Próxima facturación",
      freePlanDescription: "Tu cuenta utiliza actualmente el plan gratuito.",
